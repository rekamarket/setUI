...
const providers = ['gmail.com', 'yandex.ru', 'ya.ru']
...
const Footer = () => {
  ...
  const emailList = useMemo(() => {
    ...
    return name ? providers.map((e) => `${name}@${e}`) : []
  }, [email])
  ...
  return (
    <footer className={css.footer}>
      <H2 textAlign="center">Подписывайтесь на обновления блога</H2>
      ...
      <form className={css.form} onSubmit={handleSubmit}>
        ...
        <button className={css.button}>Подписаться</button>
      </form>
      ...
      {isSubmitted && (
        <div className={css.alert} aria-live="assertive">
