...
export const TextTransformLayer_resolve: (_1:{ readonly textTransform: TextTransform_TextTransform_t }) => string = function (Arg1: any) {
  const result = TextTransformLayerBS.TextTransformLayer.resolve(Arg1.textTransform);
  return result
};
