...
@module("./UlStyle.css.js") external classNameRoot: string = "className"

let {displayName} = module(UlMeta)
let className = classNameRoot

external dangerousTagCast: ListProto.ul => ListProto.tag = "%identity"

@react.component
let make = (
  ~tag: option<ListProto.ul>=?,
