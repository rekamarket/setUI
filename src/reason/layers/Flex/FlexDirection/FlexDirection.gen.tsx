...
export type FlexDirection_t = 'row' | 'rowReverse' | 'column' | 'columnReverse'

export interface IFlexDirection_i {
  readonly flexDirection: FlexDirection_t
}

export const FlexDirection_initial: 'row' =
  FlexDirectionBS.FlexDirection.initial
