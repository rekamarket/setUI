...
export interface IGapStyle_i {
  readonly gap: GapStyle_t
}

export const GapStyle_style: IGap_Gap_variant = GapStyle_cssBS.GapStyle.style

export const GapStyle_resolve: (
  t:
    | 'large'
    | 'medium'
    | 'none'
    ...
    | 'xxxlarge'
    | 'xxxsmall'
) => string = GapStyle_cssBS.GapStyle.resolve
...
export const GapStyle: {
  ...
  style: Gap_Gap_variant
} = GapStyle_cssBS.GapStyle
