...
export interface IMarginBlockEndStyle_i { readonly marginBlockEnd: Margin_Margin_t };

export const MarginBlockEndStyle_resolve: (t:
    "large"
  | "medium"
  | "none"
  | "small"
  ...
  | "xxsmall"
  | "xxxlarge"
  | "xxxsmall") => string = MarginBlockEndStyle_cssBS.MarginBlockEndStyle.resolve;

export const MarginBlockEndStyle: { resolve: (t:
    "large"
  | "medium"
  | "none"
  | "small"
  ...
  | "xxsmall"
  | "xxxlarge"
  | "xxxsmall") => string } = MarginBlockEndStyle_cssBS.MarginBlockEndStyle
