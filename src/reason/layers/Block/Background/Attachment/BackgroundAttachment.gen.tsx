...
export interface IBackgroundAttachment_i { readonly backgroundAttachment: BackgroundAttachment_t };

export const BackgroundAttachment_initial: "scroll" = BackgroundAttachmentBS.BackgroundAttachment.initial;
...
export const BackgroundAttachment: { options: {
  readonly fixed: string; 
  readonly inherit: string; 
  readonly initial: string; 
  readonly local: string; 
  ...
  readonly scroll: string; 
  readonly unset: string
}; initial: "scroll" } = BackgroundAttachmentBS.BackgroundAttachment
