...
export interface IBackgroundOrigin_i { readonly backgroundOrigin: BackgroundOrigin_t };

export const BackgroundOrigin_initial: "paddingBox" = BackgroundOriginBS.BackgroundOrigin.initial;
...
export const BackgroundOrigin: { options: {
  readonly borderBox: string; 
  readonly contentBox: string; 
  readonly inherit: string; 
  readonly initial: string; 
  ...
  readonly revert: string; 
  readonly unset: string
}; initial: "paddingBox" } = BackgroundOriginBS.BackgroundOrigin
