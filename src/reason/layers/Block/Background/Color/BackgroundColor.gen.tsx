...
export interface IBackgroundColor_i { readonly backgroundColor: BackgroundColor_t };

export const BackgroundColor_initial: "primary" = BackgroundColorBS.BackgroundColor.initial;
...
export const BackgroundColor: { options: {
  readonly black: {
    readonly hue: string; 
    readonly lightness: string; 
    readonly saturation: string
...
}; initial: "primary" } = BackgroundColorBS.BackgroundColor
