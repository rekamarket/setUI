...
export interface IBackgroundClip_i { readonly backgroundClip: BackgroundClip_t };

export const BackgroundClip_initial: "borderBox" = BackgroundClipBS.BackgroundClip.initial;
...
export const BackgroundClip: { options: {
  readonly borderBox: string; 
  readonly contentBox: string; 
  readonly inherit: string; 
  readonly initial: string; 
  ...
  readonly text: string; 
  readonly unset: string
}; initial: "borderBox" } = BackgroundClipBS.BackgroundClip
