...
export interface ISpacingBeforeStyle_i { readonly spacingBefore: Spacing_Spacing_t };

export const SpacingBeforeStyle_resolve: (t:
    "large"
  | "medium"
  | "none"
  | "small"
  ...
  | "xxsmall"
  | "xxxlarge"
  | "xxxsmall") => string = SpacingBeforeStyle_cssBS.SpacingBeforeStyle.resolve;

export const SpacingBeforeStyle: { resolve: (t:
    "large"
  | "medium"
  | "none"
  | "small"
  ...
  | "xxsmall"
  | "xxxlarge"
  | "xxxsmall") => string } = SpacingBeforeStyle_cssBS.SpacingBeforeStyle
