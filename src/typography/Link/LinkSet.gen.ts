/* TypeScript file generated from LinkSet.res by genType. */
...
import * as LinkSetBS__Es6Import from './LinkSet.js';
const LinkSetBS: any = LinkSetBS__Es6Import;
...
export const LinkSet_make: React.ComponentType<{
  readonly children: React.ReactNode; 
  readonly className?: string; 
  readonly color?: Color_Color_t; 
  readonly fontFamily?: FontFamily_FontFamily_t; 
  ...
  readonly textDecorationThickness?: TextDecorationThickness_TextDecorationThickness_t; 
  readonly textTransform?: TextTransform_TextTransform_t
}> = LinkSetBS.LinkSet.make;

export const LinkSet: { make: React.ComponentType<{
  readonly children: React.ReactNode; 
  readonly className?: string; 
  readonly color?: Color_Color_t; 
  readonly fontFamily?: FontFamily_FontFamily_t; 
