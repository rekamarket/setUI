...
let list: (~tag: string, ~children: option<string>, ~props: option<array<R.prop>>) => array<R.t> = (
  ...
  [
    [
      {
        title: "Semantics",
        description: `Значение по умолчанию - b; Можно указать теги - ["abbr", "data", "dd", "dt", "i", "small", "span", "strong"]`->Some,
        root: Root({
          tag: R.defaultTag,
          ...
          children: R.block(.
            ...
            ~children,
            ~key="tag",
            ~values=["abbr", "data", "dd", "dt", "i", "small", "span", "strong"]->R.toStringArray,
