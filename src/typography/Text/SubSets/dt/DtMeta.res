...
let list: (~tag: string, ~children: option<string>, ~props: option<array<R.prop>>) => array<R.t> = (
  ...
  [
    [
      {
        title: "Semantics",
        description: `Значение по умолчанию - dt; Можно указать теги - ["abbr", "b", "data", "dd", "i", "small", "span", "strong"]`->Some,
        root: Root({
          tag: R.defaultTag,
          ...
          children: R.block(.
            ...
            ~children,
            ~key="tag",
            ~values=["abbr", "b", "data", "dd", "i", "small", "span", "strong"]->R.toStringArray,
