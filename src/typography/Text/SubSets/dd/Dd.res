...
@module("./DdStyle.css.js") external classNameRoot: string = "className"

let { displayName } = module(DdMeta)
let className = classNameRoot

external dangerousTagCast: TextProto.dd => TextProto.tag = "%identity";

@react.component
let make = (
//  ~nodeRef: option<ReactDOM.domRef>=?,
  ~tag: option<TextProto.dd>=?,
